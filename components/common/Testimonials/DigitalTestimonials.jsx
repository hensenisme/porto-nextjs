                  ...
                  <div className="d-flex align-items-center">
                    <div>
                      <div className="img fit-img">
                        <Image src="/assets/imgs/testim/t1.jpg" alt="client" width={80} height={80} style={{ width: '100%', height: 'auto', borderRadius: '50%' }} />
                      </div>
                    </div>
                    <div className="ml-20">
              ...
              <div className="item">
                ...
                <div className="info">
                  <div className="d-flex align-items-center">
                    <div>
                      <div className="img fit-img">
                        <Image src="/assets/imgs/testim/t2.jpg" alt="client" width={80} height={80} style={{ width: '100%', height: 'auto', borderRadius: '50%' }} />
                      </div>
                    </div>
                    <div className="ml-20">
                      <h6 className="fz-18">Haitham Al-Dukhin</h6>
              ...
              <div className="item">
                ...
                <div className="info">
                  <div className="d-flex align-items-center">
                    <div>
                      <div className="img fit-img">
                        <Image src="/assets/imgs/testim/t3.jpg" alt="client" width={80} height={80} style={{ width: '100%', height: 'auto', borderRadius: '50%' }} />
                      </div>
                    </div>
                    <div className="ml-20">
                      <h6 className="fz-18">Haitham Al-Dukhin</h6>
